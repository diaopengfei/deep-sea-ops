...
const (
	AgentService_Connect_FullMethodName = "/deepsea.agent.AgentService/Connect"
)
...
var AgentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "deepsea.agent.AgentService",
